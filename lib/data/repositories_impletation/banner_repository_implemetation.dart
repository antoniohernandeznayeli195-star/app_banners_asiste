...
class BannerRepositoryImpl {
  ...
  Future<List<BannerModel>> getBanners(String type) async {
    try {
      String blobName = (type == "interno") ? Constants.bannerInterno : Constants.bannerExterno;
  ...
  Future<String?> uploadImageOnly(String imagePath) async {
    try {
      ...
      if ((response.statusCode == 201 || response.statusCode == 200) && response.data['imageUrl'] != null) {
